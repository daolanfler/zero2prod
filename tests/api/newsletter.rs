...
async fn concurrent_form_submission_is_handled_gracefully() {
    ...
    Mock::given(path("/email"))
        ...
        // arrives efore the first one completes
...
//     // Email delivery should only be invoked once
//     // FIXME 当前是有问题的，对所有的 subscribers 发送邮件都在一个 transaction 内，当发生错误 early return 的时候
//     // 当 `Transaction<'static, Postgres>` dropped 的时候触发 rollback
//     when_sending_an_email()
//         .respond_with(ResponseTemplate::new(200))
//         .expect(1)

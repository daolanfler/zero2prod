...
pub struct TestApp {
    ...
    // share same `Client` instance, enable cookie store
...
impl TestApp {
    ...
    /// Send a post request for subscription
    ...
    pub fn get_confirmation_links(&self, email_request: &wiremock::Request) -> ConfirmationLinks {
        ...
        let get_link = |s: &str| {
            ...
            // Let's rewrite the URL to include the application port
...
pub async fn spawn_app() -> TestApp {
    ...
    let configuration = {
        ...
        // Use the mock server as email API 使用 mock server 作为外部 API 服务

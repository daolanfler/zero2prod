...
#[tracing::instrument(name = "Valiate credentials", skip(credentials, pool))]
...
// we extract the db-querying logic in its own function with its own span
...
pub async fn change_password(
    ...
    let password_hash = spwan_blocking_with_tracing(move || compute_password_has(password))
        .await?
